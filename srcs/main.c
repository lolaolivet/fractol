...
#include "fractol.h"
#define USAGE "<Mandelbrot | Julia | Burningship | Douady | Tricorn>"
...
** {
** mlx_string_put(d->mlx_ptr, d->win_ptr, 10, 10, 0xFFFFFF,
** "TON INTERFACE PUE DU BELIN");
** }
*/
